                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">사진편집</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">사진편집</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <div class="img-container">
                                            <img id="image" src="/brocoli/resources/ownerResources/images/card-img-1.jpg" alt="Picture">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <!-- <h3>Preview:</h3> -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-outline-light" id="download" href="javascript:void(0);" download="Cropped.jsp">Download</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--     <script src="/brocoli/resources/ownerResources/vendor/bootstrap/js/bootstrap.bundle.js"></script> -->
    ...
    <script src="/brocoli/resources/ownerResources/vendor/cropper/dist/cropper.min.js"></script>
    <script src="/brocoli/resources/ownerResources/vendor/cropper/dist/cropper-int.js"></script>
</body>
