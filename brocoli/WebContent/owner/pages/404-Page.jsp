        ...
        <nav class="navbar navbar-expand dashboard-top-header bg-white">
            <div class="container-fluid">
                ...
                <div class="dashboard-nav-brand">
                    <a class="dashboard-logo" href="/brocoli/owner/owner.jsp">Brocoil</a>
                </div>
                <!-- ============================================================== -->
                <!-- end brand logo -->
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="error-section">
                            <img src="/brocoli/resources/ownerResources/images/404page-img.jpeg" alt="" class="img-fluid">
                            <div class="error-section-content">
                                <h1>해당페이지는 아직 제작중 입니다.</h1>
                                <p> 불편끼쳐드려 죄송합니다. 해당 페이지는 아직 제작단계로 빠른 시일 내에 찾아뵙겠습니다  감사합니다.</p>
                                <a href="/brocoli/owner/owner.jsp" class="btn btn-secondary btn-lg">오너 메인페이지로 </a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-dark text-center">
                            Copyright © 2018 Concept. All rights reserved. made by Juwan_park95 <a href="https://colorlib.com/wp/">Juwan</a>.
                        </div>
                    </div>
                </div>
            </div>
