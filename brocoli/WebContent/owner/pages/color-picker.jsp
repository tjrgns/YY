...
<head>
    ...
    <link href="/brocoli/resources/ownerResources/vendor/bootstrap-colorpicker/%40claviska/jquery-minicolors/jquery.minicolors.css" rel="stylesheet">
...
<body>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">부가기능</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">RGB 색상표</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
    ...
    <!-- ============================================================== -->
    <!-- Optional JavaScript -->
    <script src="c/vendor/jquery/jquery-3.3.1.min.js"></script>
    ...
    <!-- This Page JS -->
    <script src="/brocoli/resources/ownerResources/vendor/bootstrap-colorpicker/jquery-asColor/dist/jquery-asColor.min.js"></script>
    <script src="/brocoli/resources/ownerResources/vendor/bootstrap-colorpicker/jquery-asGradient/dist/jquery-asGradient.js"></script>
    <script src="/brocoli/resources/ownerResources/vendor/bootstrap-colorpicker/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"></script>
    <script src="/brocoli/resources/ownerResources/vendor/bootstrap-colorpicker/%40claviska/jquery-minicolors/jquery.minicolors.min.js"></script>
    <script>
    $('.demo').each(function() {
        //
