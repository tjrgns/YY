...
더 자세한 내용에 대해서는 개인정보처리방침을 참고하시기 바랍니다. 			
   			...
   			<div>
<pre id="agree">
제1조(목적) 이 약관은 주식회사 무신사가 운영하는 사이버 몰 “BROCOLI”(이하 “몰”이라 한다)에서 
제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를이용함에 있어 사이버 몰과 이용자의 
...
개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 00 사이버몰의 초기 서비스화면(전면)에 게시합니다.
...
"몰"이용자의 귀책 사유로 인해 회원의 소재가 불명확한 경우 "몰"은 당해 물품을 발송인에게 반송하고 이를 회원에게 통보하며,
 소요비용은 "몰"이용자로부터 정산하거나 "몰"의 임의대로 물품을 처리하여 충당할 수 있습니다.
가.
관세법 제234조(수출입의 금지) 다음 각호의 1에 해당하는 물품은 수출 또는 수입할 수 없다.
1)
헌법질서를 문란하게 하거나 공공의 안녕질서 또는 풍속을 해치는서적•간행물•도화•영화•음반• 비디오물•조각물 기타 이에 준하는 물품
...
① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」
 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 
 재화 등의 공급이 시작된 날을 말합니다)부터 7일 이내에는 청약의 철회를 할 수 있습니다. 
...
주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 
...
② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
   			...
   			<div style="display: inline-flex">
   			<input type="checkBox" name="cate" id="ck" value="">&nbsp; BROCOLI 이용 약관 동의(필수)
   			</div>
   			<div>
   			<pre id="agree">
