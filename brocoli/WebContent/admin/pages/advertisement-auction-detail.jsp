					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="page-header">
								<h2 class="pageheader-title">광고경매</h2>
								<div class="page-breadcrumb">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											<li class="breadcrumb-item">광고경매</a></li>
											<li class="breadcrumb-item">경매신청현황</a></li>
							...
							<div class="card">
								...
								<div class="card-footer bg-white">
									...
									<div class="card-footer float-right"
										...
										<form action="/brocoli/admin/pages/advertisement-auction.jsp"
